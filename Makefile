CC := g++-14
PYTHON := python3.10
CFLAGS := -std=c++20 -Wall -Wextra -O3 -mtune=native -mcpu=native -fopenmp -I/usr/local/include -L/Users/tomotaka/Downloads/MulticellularMolecularCommunicationSystemSimulator-main -L/usr/local/lib -lyaml-cpp -I src/thirdparty
DEBUGF := -std=c++20 -Wall -Wextra -gdwarf-3 -fopenmp -g -I/usr/local/include -L/usr/local/lib -L/Users/tomotaka/Downloads/MulticellularMolecularCommunicationSystemSimulator-main -lyaml-cpp
TESTFLAGS := -std=c++20 -Wall -Wextra -lgtest -lgtest_main  -I/usr/local/include  -L/usr/local/lib -L/Users/tomotaka/Downloads/MulticellularMolecularCommunicationSystemSimulator-main -lyaml-cpp
OBJS := Vec3.o Cell.o Simulation.o CellList.o UserSimulation.o UserCell.o SimulationSettings.o MoleculeSpace.o UserMoleculeSpace.o BarnesHut.o Cluster.o NaiveAlgorithm.o
DOBJS := D_Vec3.o D_Cell.o D_Simulation.o D_CellList.o D_UserSimulation.o D_UserCell.o D_SimulationSettings.o D_MoleculeSpace.o D_UserMoleculeSpace.o D_BarnesHut.o D_Cluster.o D_NaiveAlgorithm.o
...
BarnesHut.o: $(CORE)/CellList.cpp $(CORE)/BarnesHut.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp SimulationSettings.o
	$(CC) -c $(CFLAGS) $(CORE)/BarnesHut.cpp

D_BarnesHut.o: $(CORE)/BarnesHut.cpp $(CORE)/BarnesHut.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp D_SimulationSettings.o
	$(CC) -c -o $@ $(DEBUGF) $(CORE)/BarnesHut.cpp
	
Cluster.o: $(CORE)/Cluster.cpp $(CORE)/Cluster.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp SimulationSettings.o
	$(CC) -c $(CFLAGS) $(CORE)/Cluster.cpp

D_Cluster.o: $(CORE)/CellList.cpp $(CORE)/Cluster.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp D_SimulationSettings.o
	$(CC) -c -o $@ $(DEBUGF) $(CORE)/Cluster.cpp
	
NaiveAlgorithm.o: $(CORE)/NaiveAlgorithm.cpp $(CORE)/NaiveAlgorithm.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp SimulationSettings.o
	$(CC) -c $(CFLAGS) $(CORE)/NaiveAlgorithm.cpp

D_NaiveAlgorithm.o: $(CORE)/NaiveAlgorithm.cpp $(CORE)/NaiveAlgorithm.hpp $(CORE)/Cell.hpp $(CORE)/Cell.cpp D_SimulationSettings.o
	$(CC) -c -o $@ $(DEBUGF) $(CORE)/NaiveAlgorithm.cpp
