...
class MoleculeSpace
{
  protected:
    ...
    std::vector<Cell*>& cells; // 格子の情報を格納する配列
  ...
  public:
    MoleculeSpace(const uint64_t moleculeNum, const MoleculeDistributionType distributionType, const MoleculeSpaceBorderType borderType, std::vector<Cell*>& cells,
