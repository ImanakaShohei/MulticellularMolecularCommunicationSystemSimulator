...
class NormalCell : public Cell
{
    ...
    public:
    NormalCell();
    NormalCell(CellType _typeID, double x, double y, double radius = 5.0, double vx = 0, double vy = 0);
    NormalCell(CellType _typeID, Vec3 pos, double radius = 5.0, Vec3 v = Vec3::zero());
    ...
    // TODO: Simulation, UserSimulationにおいて、NormalCellをどのように使うのかよく考える
    // TODO: これの挙動をよく考える！
    NormalCell divide() noexcept;
