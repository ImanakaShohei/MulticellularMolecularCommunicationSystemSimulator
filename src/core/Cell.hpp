...
class Cell
{
  ...
  public:
    ...
    constexpr Vec3 getPeriodAddedForce() const noexcept;
...
/**
 * @brief 1step前にCellに加えられた力を返す
 *
 * @return Vec3 Cellの座標
 */
constexpr Vec3 Cell::getPeriodAddedForce() const noexcept
{
    return periodAddedForce;
}
