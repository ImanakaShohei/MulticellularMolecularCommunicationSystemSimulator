...
double MoleculeSpace::production(int32_t, int32_t, int32_t)
{
    return 0.0;
}

double MoleculeSpace::decay(int32_t, int32_t, int32_t)
{
    return 0.0;
}

double MoleculeSpace::advection(int32_t, int32_t, int32_t)
{
    return 0.0;
}
